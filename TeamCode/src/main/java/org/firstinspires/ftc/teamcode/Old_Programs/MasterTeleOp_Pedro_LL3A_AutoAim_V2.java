...
@TeleOp(name = "MasterTeleOp_Pedro_LL3A_TagsOnly", group = "TeleOp")
public class MasterTeleOp_Pedro_LL3A_AutoAim_V2 extends OpMode {
    ...
    public void init() {
        ...
        telemetry.addLine("Initialized V11 (Tags Only)");
        telemetry.update();
    }
    ...
    public void loop() {
        ...
        // Re-Localize (GP1 Start)
        if (gamepad1.start && tagVisible) {
    ...
    private void updateVisionLogic() {
        // No Pipeline Switching - Always Pipeline 0
        ...
        if (gamepad2.a) {
            ...
            switch (currentFireState) {
                ...
                case WAITING:
                    ...
                    break;
                case IDLE: feeder.setPower(0); break;
            }
        }
    ...
    private void handleFlywheel(double voltComp) {
        ...
        // Auto-RPM (GP1 Left Bumper) - Always works now since we are always on Pipeline 0
