...
@Autonomous(name = "DECODE Auto: Red (Forward)", group = "Autonomous")
public class DecodeAuto_Forward_Red extends OpMode {
    ...
    // Coordinates (Red Linear)
    private final Pose startPose = new Pose(122.47, 122.27, Math.toRadians(180));
    private final Pose shootPose1 = new Pose(85.83, 85.19, Math.toRadians(46));
    private final Pose intakePose = new Pose(127.06, 84.68, Math.toRadians(46));
    private final Pose shootPose2 = new Pose(85.92, 85.33, Math.toRadians(46));
    private final Pose parkPose = new Pose(86, 61, Math.toRadians(46));
